...
/*!*********************************!*\
  ...
  \*********************************/
/*! exports provided: initTextDrops */function(e,t,n){"use strict";n.r(t),n.d(t,"initTextDrops",(function(){return s}));var i={mobile:"(max-width:767px)"},o=function(e,t,n){if(t.length)for(var i=0;i<t.length;i++)i>=n&&(t[i].style.display="none");e.classList.add("is-closed")},a=document.querySelectorAll("[data-text-drop]"),s=function(){if(a.length)for(var e=function(){var e=a[t],n=e.querySelector("[data-text-drop-content]"),s=n.children,r=n.dataset.textDropContent||3,l=n.querySelector("[data-hidden-more]"),c=e.querySelector("[data-text-drop-button]");o(e,s,r);var u=window.matchMedia(i[l.dataset.hiddenMore]),d=function(){u.matches&&e.classList.contains("is-closed")?l.style.display="none":l.style.display="block"};u.addEventListener("change",d),d();c.addEventListener("click",(function(){e.classList.contains("is-closed")?(!function(e,t,n){if(t.length)for(var i=0;i<t.length;i++)i>=n&&(t[i].style.display="block");e.classList.remove("is-closed")}(e,s,r),l.style.display="block"):o(e,s,r),d()}))},t=0;t<a.length;t++)e()}},"./js/utils/focus-lock.js":
/*!********************************!*\

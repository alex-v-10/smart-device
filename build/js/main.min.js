...
/* harmony import */ var _modules_text_drop__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/text-drop */ "./js/modules/text-drop.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    window.form = form;
    form.init();
    Object(_modules_text_drop__WEBPACK_IMPORTED_MODULE_3__["initTextDrops"])();
    Object(_modules_accordion__WEBPACK_IMPORTED_MODULE_4__["initAccordion"])('footer', 2, MOBILE_MEDIA);
    Object(_modules_accordion__WEBPACK_IMPORTED_MODULE_4__["initAccordion"])('footer-2', null, MOBILE_MEDIA);
  });
});
...
var getAccordionElements = function getAccordionElements(accordionId) {
  return document.querySelectorAll("[data-accordion=".concat(accordionId, "]"));
};
var createOnAccordionAction = function createOnAccordionAction(accordionElements) {
...
var openInitialAccordionElement = function openInitialAccordionElement(accordionElements, initial) {
  var initialAccordion = accordionElements[initial - 1] || accordionElements[0];
  initialAccordion.classList.remove('is-closed');
  initialAccordion.nextElementSibling.style.display = 'block';
};
var initAccordion = function initAccordion(accordionId, initial, media) {
  var accordionElements = getAccordionElements(accordionId);
  var onAccordionAction = createOnAccordionAction(accordionElements);
  if (accordionElements.length) {
    ...
    var breakpointChecker = function breakpointChecker() {
      if (breakpoint.matches) {
        ...
        for (var _i = 0; _i < accordionElements.length; _i++) {
          accordionElements[_i].classList.remove('is-on');
          accordionElements[_i].classList.remove('is-closed');
          accordionElements[_i].nextElementSibling.removeAttribute('style');
          accordionElements[_i].removeAttribute('tabindex');
          accordionElements[_i].removeEventListener('click', onAccordionAction);
          accordionElements[_i].removeEventListener('keypress', onAccordionAction);
        }
      }
    };
...
/*!*********************************!*\
  !*** ./js/modules/text-drop.js ***!
  \*********************************/
/*! exports provided: initTextDrops */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initTextDrops", function() { return initTextDrops; });
// Init text block to open and close on button click.
// [data-text-drop-content] contains amount of items to show.

var closeContainer = function closeContainer(dropContainer, dropItems, itemsToShow) {
  if (dropItems.length) {
...
var openContainer = function openContainer(dropContainer, dropItems, itemsToShow) {
  if (dropItems.length) {
    for (var i = 0; i < dropItems.length; i++) {
      if (i >= itemsToShow) {
...
var dropContainers = document.querySelectorAll('[data-text-drop]');
var onTextDropButtonClick = function onTextDropButtonClick(event) {
  var currentDropContainer = event.target.closest('[data-text-drop]');
  var currentDropContent = currentDropContainer.querySelector('[data-text-drop-content]');
  var currentDropItems = currentDropContent.children;
  var currentItemsToShow = currentDropContent.dataset.textDropContent || 2;
...
var initTextDrops = function initTextDrops() {
  if (dropContainers.length) {
    for (var i = 0; i < dropContainers.length; i++) {
      var dropContainer = dropContainers[i];
      var dropContent = dropContainer.querySelector('[data-text-drop-content]');
      var dropItems = dropContent.children;
      var itemsToShow = dropContent.dataset.textDropContent || 2;
      var dropButton = dropContainer.querySelector('[data-text-drop-button]');

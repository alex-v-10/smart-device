...
/* harmony import */ var _modules_init_about__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/init-about */ "./js/modules/init-about.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    window.form = form;
    form.init();
    Object(_modules_init_about__WEBPACK_IMPORTED_MODULE_3__["initAbout"])();
...
var onAccordionClick = function onAccordionClick(event) {
  if (window.innerWidth > WIDTH) {
    return;
  }
  for (var _i = 0; _i < accordionElements.length; _i++) {
    if (accordionElements[_i] !== event.target) {
      accordionElements[_i].classList.remove('accordion--active');
    }
  }
...
var initAccordion = function initAccordion() {
  if (accordionElements.length) {
    for (var _i2 = 0; _i2 < accordionElements.length; _i2++) {
      accordionElements[_i2].addEventListener('click', onAccordionClick);
    }
  }
};
...
var container = document.querySelector('.about__container');
if (container) {

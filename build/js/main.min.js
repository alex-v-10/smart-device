...
var initAccordions = function initAccordions() {
  ...
  if (parents.length) {
    var _loop = function _loop() {
      var buttons = parents[i].querySelectorAll('[data-accordion="button"]');
      if (buttons.length) {
        var _loop2 = function _loop2(j) {
          var breakpoint = window.matchMedia(parents[i].dataset.focus);
...
var initTextDrops = function initTextDrops() {
  if (dropContainers.length) {
    var _loop = function _loop() {
      ...
      var itemsToShow = dropContent.dataset.textDropContent || BASE_QUANTITY;
      var hiddenMore = dropContent.querySelector('[data-hidden-more]');
      var dropButton = dropContainer.querySelector('[data-text-drop-button]');
      closeContainer(dropContainer, dropItems, itemsToShow);
      var breakpoint = window.matchMedia(hiddenMore.dataset.hiddenMore);
      var breakpointChecker = function breakpointChecker() {
      ...
      breakpoint.addEventListener('change', breakpointChecker);
      breakpointChecker();
      var onTextDropButtonClick = function onTextDropButtonClick() {
